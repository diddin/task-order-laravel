                    ...
                    <tbody>
                        @forelse ($networks as $network)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="p-2">
                                    <a href="{{ route('networks.show', $network) }}" class="text-blue-500">Lihat</a> |
                                    <a href="{{ route('networks.edit', $network) }}" class="text-yellow-500">Edit</a> |
                                    <form action="{{ route('networks.destroy', $network) }}" method="POST" class="inline"
