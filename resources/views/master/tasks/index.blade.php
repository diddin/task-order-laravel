<x-dynamic-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <a href="{{ route('master.tasks.create') }}" class="ml-1 mb-4 inline-block bg-blue-600 text-white px-4 py-2 rounded">
                + Tambah tiket
            </a>
                        ...
                        @forelse($tasks as $task)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="p-2">
                                    ...
                                    <a href="{{ route('master.tasks.edit', $task) }}" class="text-yellow-500">Edit</a> |
                                    <form action="{{ route('master.tasks.destroy', $task) }}" method="POST" class="inline" onsubmit="return confirm('Delete this task?')">
                                        @csrf @method('DELETE')
