<x-dynamic-layout>
    ...
    <div class="flex-1 ml-64 p-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <a href="{{ route('master.networks.create') }}"
                    ...
                    <tbody>
                        @forelse ($networks as $network)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="p-2">
                                    <a href="{{ route('master.networks.show', $network) }}" class="text-blue-500">Lihat</a> |
                                    <a href="{{ route('master.networks.edit', $network) }}" class="text-yellow-500">Edit</a> |
                                    <form action="{{ route('master.networks.destroy', $network) }}" method="POST" class="inline"
